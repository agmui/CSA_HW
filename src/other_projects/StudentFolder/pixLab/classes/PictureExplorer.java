...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    //Picture pix = new Picture("./src/other_projects/StudentFolder/pixLab/images/beach.jpg");
    //Picture pix = new Picture("./src/other_projects/StudentFolder/pixLab/images/arch.jpg");
    Picture pix = new Picture("./src/other_projects/StudentFolder/pixLab/images/122002750_792920851547649_619273314644593133_n (copy).jpg").scale(.25,.25);
    pix.explore();
  }
